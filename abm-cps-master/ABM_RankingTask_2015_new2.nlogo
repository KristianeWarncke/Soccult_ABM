...
to go
  ...
  ask turtles [
    if (stoch-step [neuroticism] of self)
                  [ ; feeling agreeable
...
to report-stop-condition
      ifelse reached_consensus? [
       ...
       if (ticks > 150) [type "Ran out of allotted time. Stopping!\n"]
      ]
      ;file-close
end
...
<experiments>
  ...
  <experiment name="own_abm2" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>mu_agree</metric>
    <metric>sd_agree</metric>
  ...
  <experiment name="own_abm" repetitions="1000" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <metric>team_score</metric>
    <metric>gain_score</metric>
